...
AddIn xai_sort( //what is xai
	Function(XLL_LPOPER, L"?xll_sort", L"XLL.SORT")
	.Arg(XLL_LPOPER, L"range", L"is a range.")  ///not changed
	.FunctionHelp(L"Sort entries based on size.")
	.Category(CATEGORY)
);
LPOPER WINAPI xll_sort(LPOPER po)  //what is po
{
#pragma XLLEXPORT
	static OPER o;
